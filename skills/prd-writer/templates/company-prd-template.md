# Acme PRD Template (Compact)

Default PRD template — Acme Boards conventions. Apply quality patterns from `quality-patterns.md` throughout.
...
1. [P0] [Observable system behavior — max 2 logical statements]
2. [P0] [Happy path behavior]
3. [P0] [Error/validation behavior]
4. [P1] [Polish/enhancement — overrides area default when appropriate]
...
2. [P1] [Constraint/rule that governs this behavior]

**REQ-003: [Name]** (P2)
[P2] [One-line description only, no acceptance criteria]
...
- Acme-specific sections (RACI, Settings, Pricing) — omit if using custom template.
