...
# ABOUTME: Wraps pr-review-toolkit:code-reviewer, pr-review-toolkit:pr-test-analyzer, and pr-review-toolkit:comment-analyzer.
...
1. **pr-review-toolkit:code-reviewer** -- CLAUDE.md compliance, bug detection, code quality.
   Confidence threshold: only issues scored 80+.
2. **pr-review-toolkit:pr-test-analyzer** -- behavioral test coverage, critical gap identification,
   test quality assessment. Focus on tests rated 7+ criticality.
3. **pr-review-toolkit:comment-analyzer** -- comment accuracy vs code, comment rot detection,
...
### Step 2: Invoke pr-review-toolkit:code-reviewer
...
### Step 3: Invoke pr-review-toolkit:pr-test-analyzer
...
### Step 4: Invoke pr-review-toolkit:comment-analyzer
  ...
  "findings": [
    {
      ...
      "source_skill": "pr-review-toolkit:code-reviewer | pr-review-toolkit:pr-test-analyzer | pr-review-toolkit:comment-analyzer"
    }
  ],
...
- **Source:** pr-review-toolkit:code-reviewer (confidence: 95)
...
- **Source:** pr-review-toolkit:pr-test-analyzer (criticality: 8)
