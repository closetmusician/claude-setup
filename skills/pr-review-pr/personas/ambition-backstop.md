...
# ABOUTME: Wraps simplify and pr-briefing (for large PRs).
...
2. **simplify** -- identifies complexity that can be reduced,
  ...
  "findings": [
    {
      ...
      "source_skill": "simplify | pr-briefing"
    }
  ],
  "removal_candidates": [
