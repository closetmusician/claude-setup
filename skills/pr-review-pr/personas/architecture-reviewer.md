...
# ABOUTME: Wraps garry-review (architecture), pr-review-toolkit:type-design-analyzer, and pr-review-toolkit:silent-failure-hunter.
...
2. **pr-review-toolkit:type-design-analyzer** -- invariant strength, encapsulation quality,
   type usefulness. Skipped if the PR introduces no types or interfaces.
3. **pr-review-toolkit:silent-failure-hunter** -- error propagation paths, catch-block
...
### Step 3: Invoke pr-review-toolkit:type-design-analyzer
...
### Step 4: Invoke pr-review-toolkit:silent-failure-hunter
  ...
  "findings": [
    {
      ...
      "source_skill": "garry-review | pr-review-toolkit:type-design-analyzer | pr-review-toolkit:silent-failure-hunter"
    }
  ],
  "strengths": [
...
- **Source:** pr-review-toolkit:silent-failure-hunter
