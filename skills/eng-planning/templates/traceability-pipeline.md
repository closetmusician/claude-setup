...
|-------------|-------------|
| `{TRACE_DIR}` | Working directory for intermediate files (e.g., `docs/.eng-planning/traceability/`) |
...
Phase 2: Synthesis (1 agent)
  └─ Agent 3 (sonnet): Gap Analysis + Verdict    → {TRACE_DIR}/traceability-matrix.md
```
