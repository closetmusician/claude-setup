...
│   ├── feature-enablement/     #   Sales/CS enablement asset generation
...
| **feature-enablement** | Generates sales/CS enablement materials from PRDs, designs, and competitive research. Produces a 7-section messaging foundation, then derives battle cards, FAQs, competitive analysis, sales 1-pagers, and demo scripts. Commands: `init`, `update`, `demo`, `add-competitor`, `roadmap`. |
...
### Option 1: Full Install (Recommended for Acme team)
